...
const TaskCard = ({ task, index, handleTaskChanged }) => {
    ...
    const deleteTask = async (taskId) => {
        try {
            ...
            console.log("Lỗi khi xoá nhiệm vụ", error);
    ...
    const toggleTaskCompleteButton = async () => {
        try {
            ...
            console.log("Lỗi xảy ra khi chuyển đổi trạng thái nhiệm vụ", error);
                ...
                <div className='flex-1 min-w-0'>
                    {isEditing ? (
                        <Input
                            ...
                            type="text"
                            className='flex h-12 text-base border-border/50 focus:border-primary/50 focus:ring-primary/20'
